...
module.exports = {
  ...
  getProductCategory : function(req, res){
    ...
    productUtil.getProductCategory(category).then(result => {
      res.json(result)
    })
  },

  getProductAgeType : function(req, res) {
  ...
  getAllProductName : function(req, res) {
    productUtil.getProductName().then(result => {
      res.json(result)
    })
  }
